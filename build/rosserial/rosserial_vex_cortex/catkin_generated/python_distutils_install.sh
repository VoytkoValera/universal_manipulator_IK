...
echo_and_run cd "/home/user/4_ws/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/user/4_ws/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/user/4_ws/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
